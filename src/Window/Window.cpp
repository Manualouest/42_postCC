...
/*   Updated: 2025/07/08 20:58:26 by mbirou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
v3		Window::mixWay = {1, 0, 0};
bool	Window::select = false;
v3		Window::mousePos = {0, 0, 0};
v3		Window::lightColor = {1, 1, 1};
...
Window::Window()
{
	...
	// glfwSetWindowPos(_window, _monitorWidth / 2 - width / 2, _monitorHeight / 2 - height / 2);
