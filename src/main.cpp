...
/*   Updated: 2025/07/06 16:47:58 by mbirou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
	...
	Texture	cat("objects/miku/face.bmp");

	Camera camera(glm::vec3(0.0f, 1.0f, -1.0f));

	camera.Matrix(45.0f, 0.1f, 100.0f, shader, "camMatrix", Window::width, Window::height);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		camera.Matrix(45.0f, 0.1f, 10000.0f, shader, "camMatrix", Window::width, Window::height);
		shader.Activate();
